...
## Switches
set_property PACKAGE_PIN V17 [get_ports swt_A]					
	set_property IOSTANDARD LVCMOS33 [get_ports swt_A]
set_property PACKAGE_PIN V16 [get_ports swt_B]					
	set_property IOSTANDARD LVCMOS33 [get_ports swt_B]
...
set_property PACKAGE_PIN R2 [get_ports swt_ATDATA]					
	set_property IOSTANDARD LVCMOS33 [get_ports swt_ATDATA]
...
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports bomba1]					
	set_property IOSTANDARD LVCMOS33 [get_ports bomba1]
##Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports bomba2]					
	set_property IOSTANDARD LVCMOS33 [get_ports bomba2]
##Sch name = JA9
